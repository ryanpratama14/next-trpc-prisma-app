...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutPositionNestedInput> = z
  .object({
    create: z
      .union([
...
export const UserUncheckedUpdateManyWithoutPositionNestedInputObjectSchema = Schema;
