...
const Schema: z.ZodType<Prisma.UserUncheckedCreateNestedManyWithoutPositionInput> = z
  .object({
    create: z
      .union([
...
export const UserUncheckedCreateNestedManyWithoutPositionInputObjectSchema = Schema;
