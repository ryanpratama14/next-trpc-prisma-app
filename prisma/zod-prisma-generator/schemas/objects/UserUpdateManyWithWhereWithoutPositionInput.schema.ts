...
const Schema: z.ZodType<Prisma.UserUpdateManyWithWhereWithoutPositionInput> = z
  .object({
...
export const UserUpdateManyWithWhereWithoutPositionInputObjectSchema = Schema;
